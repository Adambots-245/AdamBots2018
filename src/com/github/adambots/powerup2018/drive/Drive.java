...
public class Drive {
	...
	public static void autonDrive(double rightSpeed, double forwardSpeed, double zRotation, double AValue,
			double BValue, double elevatorValue) {

		// *note* Cartesian was a possibility for auton but the teleop drive method is
		// not cartesian, please resolve
