...
public class Scale_Switch extends AutonRoutine {
		...
		public void execute() {
			...
			*/
			...
			//start raise elevator
				else if (time < (AutonConstants.SCALE_STRAIGHT_END_TIME + AutonConstants.SCALE_TURN_TIME + AutonConstants.SCALE_BACK_TIME + AutonConstants.SCALE_ELEVATOR_RAISE_TIME) && scaleTurn != Character.MIN_VALUE) {
			...
			*/
			...
			//start drive to scale after reversing
				else if (time < (AutonConstants.SCALE_STRAIGHT_END_TIME + AutonConstants.SCALE_TURN_TIME + AutonConstants.SCALE_BACK_TIME + AutonConstants.SCALE_FORWARD_TIME) && scaleTurn != Character.MIN_VALUE) {
				...
				//outtake cube
				else if (time < (AutonConstants.SCALE_STRAIGHT_END_TIME + AutonConstants.SCALE_TURN_TIME + AutonConstants.SCALE_BACK_TIME + AutonConstants.SCALE_FORWARD_TIME + AutonConstants.SCALE_OUTTAKE_TIME) && scaleTurn != Character.MIN_VALUE) {
					Drive.autonDrive(Constants.STOP_MOTOR_SPEED, Constants.STOP_MOTOR_SPEED, Constants.STOP_MOTOR_SPEED);
				if(time > (AutonConstants.SCALE_STRAIGHT_END_TIME + AutonConstants.SCALE_TURN_TIME + AutonConstants.SCALE_BACK_TIME + AutonConstants.SCALE_FORWARD_TIME)) {
				...
				else if (time < (AutonConstants.SCALE_STRAIGHT_END_TIME + AutonConstants.SCALE_TURN_TIME + AutonConstants.SCALE_BACK_TIME + AutonConstants.SCALE_FORWARD_TIME + AutonConstants.SCALE_OUTTAKE_TIME + AutonConstants.SCALE_END_BACK_TIME ) && scaleTurn != Character.MIN_VALUE) {
					double speed = AutonConstants.SCALE_BACK_SPEED;
					double stop = Constants.STOP_MOTOR_SPEED;
					Drive.autonDrive(stop, speed, stop);
					System.out.println("Running straight back");
				}
				else if (time < (AutonConstants.SCALE_STRAIGHT_END_TIME + AutonConstants.SCALE_TURN_TIME + AutonConstants.SCALE_BACK_TIME + AutonConstants.SCALE_FORWARD_TIME + AutonConstants.SCALE_OUTTAKE_TIME + AutonConstants.SCALE_END_BACK_TIME + AutonConstants.SCALE_END_TURN_TIME) && scaleTurn != Character.MIN_VALUE) {
					Sensors.zeroGyro();
					double leftSpeed, rightSpeed;
					  if (position.equalsIgnoreCase("L")) {
						System.out.println("ignorecase L");
